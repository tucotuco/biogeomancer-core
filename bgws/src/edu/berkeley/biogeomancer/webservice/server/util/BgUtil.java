...
public class BgUtil {
   ...
   * @param rec
   * @param interp
   * @param response build single georeference base on given Rec, and
   *          interpreter String representation of the single georeference is
   *          return by reference as response
   */
   ...
   * @param StringBuilder response generate single georeference and append it to
   *          response
   */
  ...
  /**
   * @param Rec rec
   * @param String interpreter (for georeference)
   * @param PrintWiter out: to output xml text to the browser build xml text
   *          base on record rec
   * 
   */
  ...
  /**
   * 
   * @return HashMap of support Parameters url parameters: l,locality = locality
   *         hg,highergeography = highergeography cy, country = country s,
   *         stateprovince = stateprovince co, county = county vlat,
   *         verbatimlatitude = verbatimlatitude vlng, verbatimlongitude =
   *         verbatimlongitude is, island = island ig, islandgroup = islandgroup
   *         w, waterbody = waterbody c, continent = continent i, interpreter =
   *         interpreter (this does not get added to the record)
   */
