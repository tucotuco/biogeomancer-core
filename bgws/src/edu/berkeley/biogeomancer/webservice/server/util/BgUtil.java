...
public class BgUtil {
   ...
   * @param PrintWiter out: to output xml text to the browser
   * build xml text base on record rec
   *
   */
  public static void buildSingleXmlText(Rec rec, String interpreter, PrintWriter out)
  {
	  ...
	  //display DecimalLatitude DecimalLongitude CoordinateUncertaintyInMeters
