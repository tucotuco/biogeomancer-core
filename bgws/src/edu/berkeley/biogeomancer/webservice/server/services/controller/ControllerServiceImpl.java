...
public class ControllerServiceImpl extends RemoteServiceServlet implements
   ...
   *          loop each single georeference and return a string representation
   *          of a batch georeference
   */
  public String batchGeoreference(String xmlRequest) {
    ...
    try {
      ...
      for (Node recordNode : recordNodes) {
        ...
        BgUtil.buildSingleGeoreference(locality, higherGeography, interpreter,
            response);
      }
  ...
  /**
   * @param georef return a string representation of a single georeference
   ...
   * @param String interp return a string representation of a single
   *          georeference
   */
