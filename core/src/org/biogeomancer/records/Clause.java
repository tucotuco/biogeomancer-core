...
public class Clause // represents information about one atomic interpretable
                    // unit (Clause) of a Rec.
{
  ...
  public String iLocality; // the standardized, interpreted version of the
                            // locality clause
  public String uLocality; // the uninterpreted verbatim version of the
                            // locality clause
  public SupportedLanguages interpretedInLanguage; // the language in which the
                                                    // clause was successfully
                                                    // interpreted. Should be
  ...
  public String makeInterpretedLocality(FeatureInfo fi1, FeatureInfo fi2) {
    ...
    if (locType.equalsIgnoreCase("F") || locType.equalsIgnoreCase("P")
        || locType.equalsIgnoreCase("Q") || locType.equalsIgnoreCase("TRS")
