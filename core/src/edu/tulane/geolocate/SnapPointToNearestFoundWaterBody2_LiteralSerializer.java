...
public class SnapPointToNearestFoundWaterBody2_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    private static final javax.xml.namespace.QName ns1_WGS84Latitude_QNAME = new QName("http://www.museum.tulane.edu/webservices/", "WGS84Latitude");
    ...
    private static final javax.xml.namespace.QName ns1_WGS84Longitude_QNAME = new QName("http://www.museum.tulane.edu/webservices/", "WGS84Longitude");
    
    public SnapPointToNearestFoundWaterBody2_LiteralSerializer(javax.xml.namespace.QName type, java.lang.String encodingStyle) {
        this(type, encodingStyle, false);
    }
    
    public SnapPointToNearestFoundWaterBody2_LiteralSerializer(javax.xml.namespace.QName type, java.lang.String encodingStyle, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_WGS84Latitude_QNAME)) {
                member = ns2_myns2__double__double_Double_Serializer.deserialize(ns1_WGS84Latitude_QNAME, reader, context);
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull");
                }
                ...
                throw new DeserializationException("literal.unexpectedElementName", new Object[] { ns1_WGS84Latitude_QNAME, reader.getName() });
            }
        }
        else {
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_WGS84Longitude_QNAME)) {
                member = ns2_myns2__double__double_Double_Serializer.deserialize(ns1_WGS84Longitude_QNAME, reader, context);
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull");
                }
                ...
                throw new DeserializationException("literal.unexpectedElementName", new Object[] { ns1_WGS84Longitude_QNAME, reader.getName() });
            }
        }
        else {
            throw new DeserializationException("literal.expectedElementName", reader.getName().toString());
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        ...
        ns2_myns2__double__double_Double_Serializer.serialize(new Double(instance.getWGS84Latitude()), ns1_WGS84Latitude_QNAME, null, writer, context);
        if (new Double(instance.getWGS84Longitude()) == null) {
            throw new SerializationException("literal.unexpectedNull");
        }
        ns2_myns2__double__double_Double_Serializer.serialize(new Double(instance.getWGS84Longitude()), ns1_WGS84Longitude_QNAME, null, writer, context);
    }
}
