...
/**
 * <p>
 * An adapter class to use the original records of a BioGeomancer record set as
 * a GenericRecordSet in the data tester framework context.
 * </p>
 * 
...
public class OriginalRecordSet extends RamRecordSet {
  ...
  /**
   * <p>
   * Contructs an OriginalRecordSet for validation purposes based on a
   ...
   * @throws RecordSetException
   */
  public OriginalRecordSet(RecSet bgRecSet, Set concepts)
      throws RecordSetException {
