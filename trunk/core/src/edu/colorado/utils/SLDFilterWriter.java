...
public class SLDFilterWriter {
    ...
    private String uid;
    private String uidFldName;    
    private String sldFilePath;
...
//      PrintWriter from a Servlet
        ...
        // Start Title tag
        tagGenerator.addTag(hd, atts, "Title", "User Specific Collection Records");
        // End Title          
    ...
    public static void main(String[] args) {
        // Unit test
        SLDFilterWriter sldWriter = new SLDFilterWriter("4E29A21225531440D93DB7E88BE247931123600941806", "uid", "C:/temp/collections_uid_filter.xml");
