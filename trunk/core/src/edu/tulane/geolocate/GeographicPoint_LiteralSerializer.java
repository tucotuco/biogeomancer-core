...
public class GeographicPoint_LiteralSerializer extends
    LiteralObjectSerializerBase implements Initializable {
  private static final javax.xml.namespace.QName ns1_Latitude_QNAME = new QName(
      "http://www.museum.tulane.edu/webservices/", "Latitude");
  private static final javax.xml.namespace.QName ns2_double_TYPE_QNAME = SchemaConstants.QNAME_TYPE_DOUBLE;
  private static final javax.xml.namespace.QName ns1_Longitude_QNAME = new QName(
      "http://www.museum.tulane.edu/webservices/", "Longitude");
  private CombinedSerializer ns2_myns2__double__double_Double_Serializer;

  public GeographicPoint_LiteralSerializer(javax.xml.namespace.QName type,
  ...
  public java.lang.Object doDeserialize(XMLReader reader,
    ...
    if (reader.getState() == XMLReader.START) {
      if (elementName.equals(ns1_Latitude_QNAME)) {
        member = ns2_myns2__double__double_Double_Serializer.deserialize(
            ns1_Latitude_QNAME, reader, context);
        if (member == null) {
        ...
        throw new DeserializationException("literal.unexpectedElementName",
            new Object[] { ns1_Latitude_QNAME, reader.getName() });
      }
    } else {
    ...
    if (reader.getState() == XMLReader.START) {
      if (elementName.equals(ns1_Longitude_QNAME)) {
        member = ns2_myns2__double__double_Double_Serializer.deserialize(
            ns1_Longitude_QNAME, reader, context);
        if (member == null) {
          throw new DeserializationException("literal.unexpectedNull");
        }
        ...
        throw new DeserializationException("literal.unexpectedElementName",
            new Object[] { ns1_Longitude_QNAME, reader.getName() });
      }
    } else {
      throw new DeserializationException("literal.expectedElementName", reader
          .getName().toString());
  ...
  public void doSerialize(java.lang.Object obj, XMLWriter writer,
    ...
    ns2_myns2__double__double_Double_Serializer.serialize(new Double(instance
        .getLatitude()), ns1_Latitude_QNAME, null, writer, context);
    if (new Double(instance.getLongitude()) == null) {
      throw new SerializationException("literal.unexpectedNull");
    }
    ns2_myns2__double__double_Double_Serializer.serialize(new Double(instance
        .getLongitude()), ns1_Longitude_QNAME, null, writer, context);
  }
